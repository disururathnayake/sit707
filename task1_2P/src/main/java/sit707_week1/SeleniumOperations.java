...
public class SeleniumOperations {
	...
	public static void open_chrome_and_close() {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Users/Disuru/Downloads/chromedriver-win64/chromedriver.exe");
	...
	public static void open_chrome_loadpage_resize_close() {
	    ...
	    System.out.println("Hello from 223987245, Disuru Rathnayake");
